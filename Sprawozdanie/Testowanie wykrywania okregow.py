...
def main():
    ...
    sciezkaDocelowa = "Testowanie wykrywania okregow/1280 x 960/"
    ...
    for i in range(len(tytul)):
        ...
        ax[1].set_title("Ilosc okręgów: " + str(len(konturyOkregow)))
        ax[1].imshow(cv2.cvtColor(imageKonturyOkregow, cv2.COLOR_BGR2RGB), aspect='equal', interpolation='bilinear')
